#!/bin/bash
# OPPT Experiment Replication
# Run all 4 stages of the contradiction detection pipeline
# Note: OPPT uses annotation-guided extraction (is_oppt=True)

set -e

REPO_ROOT="$(cd "$(dirname "$0")" && pwd)"
SCRIPTS_DIR="$REPO_ROOT/scripts"
DATA_DIR="oppt_experiment_20260130"
OUTPUT_DIR="$REPO_ROOT/$DATA_DIR"
...
echo "=========================================="
echo "OPPT Experiment Replication"
echo "Data directory: $DATA_DIR"
echo "Started at: $(date)"
echo "=========================================="

echo ""
echo "=== Stage 1: Statement Extraction (with annotations) ==="
echo "Started at: $(date)"
# Run WITHOUT --data-dir to use OPPT annotations, but output to new folder
python -u extract_statements.py --output "$OUTPUT_DIR/statements.json" --delay 0.1
